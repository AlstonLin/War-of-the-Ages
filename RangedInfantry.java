...
/**
 * Write a description of class LightInfantry here.
 * 
 * @author Daniel Chung, James Ly
 * @version Beta 2.1
 */
public abstract class RangedInfantry extends Unit
{
    /**
     * Constructor for MeleeInfantry, sets its cell and map
     *
     * @param cell      The Cell that the unit will spawn in
     * @param map       The Map that this will be put into
     */
    public RangedInfantry(Player owner, Cell cell, Map map) {
        super(owner, cell, map);
        type = Unit.RANGED_INFANTRY;
    }
