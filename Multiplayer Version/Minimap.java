...
{       
    //Constants    
    public static final Color GRASS_COLOR = new Color(42, 120, 42), NATURE_COLOR = new Color(165, 120, 42), FRIENDLY_BUILDING_COLOR = Color.BLUE, 
    FRIENDLY_UNIT_COLOR = Color.CYAN, ENEMY_BUILDING_COLOR = Color.RED, ENEMY_UNIT_COLOR = Color.MAGENTA, BERRY_BUSH_COLOR = new Color(186, 129, 176), MINE_COLOR = Color.YELLOW; 
    ...
    public void update() {
        ...
        for (int i = 0; i < cells.length; i++) {
            for (int j = 0; j < cells[0].length; j++) {
                ...
                Cell cell = cells[i][j];
                if (cell instanceof Nature && (cell instanceof BerryBush)) {
                    cellColor = BERRY_BUSH_COLOR;
                } else if (cell instanceof Nature && (cell instanceof Mine)) { //Part of nature
                    cellColor = MINE_COLOR;
                } else if (cell instanceof Nature && !(cell instanceof Grass)) { //Part of nature
