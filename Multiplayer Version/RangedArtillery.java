...
/**
 * An artillery weapon that deals damage or provides as defense.
 * The damage can be dealt from far away
 * 
 * @author James Ly, Daniel Chung 
 * @version 1.0
 */
public abstract class RangedArtillery extends Unit
{
    /**
     * Constructor for RangedArtillery, sets its cell and map
     *
     * @param cell      The Cell that the unit will spawn in
     * @param map       The Map that this will be put into
     */
    public RangedArtillery(Player owner, Cell cell, Map map) {
